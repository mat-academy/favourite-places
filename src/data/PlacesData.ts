...
const place1: PlaceDataProps = {
  ...
  mapLink:
    "https://www.google.co.uk/maps/place/Sydney+NSW,+Australia/@-33.8473552,150.6511096,10z/data=!3m1!4b1!4m5!3m4!1s0x6b129838f39a743f:0x3017d681632a850!8m2!3d-33.8688197!4d151.2092955",
  placeBio:
    "Sydney is a great place to live - great weather, nearby beaches and outstanding food culture.",
};
...
const place2: PlaceDataProps = {
  ...
  placeBio:
    "The Medina in Marrakech is a lively with a sprawling market that runs out of the main square & through the city. Be careful not to get lost!",
};
...
const place4: PlaceDataProps = {
  ...
  placeBio:
    "Tamarama is slightly south of Bondi Beach but cut off from the bay by the cliffs to the North - making access slightly harder but the beach is much quieter than the Bondi strech.",
};
